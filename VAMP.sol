...
======================ROADMAP=======================
February 20th - VAMP is listed on several token trackers such as CoinGecko, CoinMarketCap, etc.
March 20th - Contact established with SpookySwap, Tomb, Fantom Foundation, and other Fantom Eco System Projects
April 29th - Deploy any new projects and pools with any partnered projects.
May 10th - Build a BLOOD BOOK system that allows a centralized exchange style order book, but using a decentralized smart contract.
...
Vampire's funding comes directly from the team and the LBP
...
contract VAMP is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor() {
        ...
        // extra addresses as you don't need that for live
        // isAllowedToProvideLiquidity[address(this)] = true;
        ...
        // isAllowedToProvideLiquidity[0x000000000000000000000000000000000000dEaD] = true;
...
// V2
// set a way to change the amount of VAMP to sell from the contract
// set min 100 and max 1000
// flush VAMP tokens in contract to the burn address
// remove dev out of it completely
//  make sure the same address can't win twice in a row
